...
// footer audio src
let footerMusic = document.getElementById("audio");
// footer play button
...
// footer volum
var volumInp = document.getElementById("volumInp");
// footer mute btn
let muteBtn = document.getElementById("mute");
// footer demute btn
let unmuteBtn = document.getElementById("unmute");
// footer start music duration
let startMusicDuration = document.getElementById("currentStart");
// footer end music duration
let endMusicDuration = document.getElementById("currentEnd");
// footer progress bar
let progressBar = document.getElementById("progressBar");

let currentpodcast = "";
let indexOfpodcast = 0;
...
// footerMusic.addEventListener("dblclick", () => {
//   // add bg to the selected element
//   ele.classList.add("bg-gray-200/20");
//   // current song that clicked on
//   currentpodcast = ele.querySelector(".audio").src;
//   // current song index
//   indexOfSong = i;
//   // show footer bar
//     footer.classList.remove("hidden");
//   // replace footer with
//   footerImg.src = ele.querySelector(".cover").src;
