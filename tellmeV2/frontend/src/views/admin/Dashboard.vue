...
<main class="flex flex-col gap-8">
    ...
    <section class="flex flex-col gap-4">
    <div>
        <h3 class="font-bold text-xl">Podcasts</h3>
 ...
 <section class="flex flex-col gap-4">
    <div>
        <h3 class="font-bold text-xl">Short Videos</h3>
 ...
 <section class="flex flex-col gap-4">
    <div>
        <h3 class="font-bold text-xl">PlayLists</h3>
 ...
 <section class="flex flex-col gap-4">
    <div>
        <h3 class="font-bold text-xl">Repports</h3>
